...
public class PingPongRight {
    ...
    public static class PlayPingPongThread extends Thread {
         ...
         */
        // TODO - You fill in here.
        SimpleSemaphore mySimpleSemaphore;
        SimpleSemaphore otherSimpleSemaphore;
        ...
        public PlayPingPongThread(String stringToPrint,
                                  ...
                                  int maxIterations) {
            // TODO - You fill in here.
        	pPString = stringToPrint;
        	mySimpleSemaphore = semaphoreOne;
        	otherSimpleSemaphore = semaphoreTwo;
        ...
        public void run() {
           ...
           int loop = 1;
            // TODO - You fill in here.
        	while (mMaxLoopIterations > loop-1){
        	acquire();
        	System.out.println(pPString+"("+loop+")");
        	release();
        	++loop;
        	}
        	mLatch.countDown();
        	
        }// try finally is optional here but would be a good idea
        //countdown through the loops would have been overkill
        ...
        private void acquire() {
            // TODO fill in here
        	mySimpleSemaphore.acquireUninterruptibly();
    ...
    public static void process(String startString, 
        ...
        PlayPingPongThread ping = new PlayPingPongThread(/*
                                                          ...
                                                          * here
                                                          */
        		pingString, pingSema, pongSema, 10);// should have used mMaxIterations here!
